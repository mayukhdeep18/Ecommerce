...
const ProductSchema = mongoose.Schema({
    ...
    PRODUCT_AVAILABILITY_COUNT: {type: String, required: true},
    PERCENTAGE_DISCOUNT_ON_PRODUCT: {type: String, required: true},
    PRODUCT_SPECIAL_OFFER_PRICE: {type: String, required: true},
    SPECIAL_OFFER_DISCOUNT_FACTOR: {type: String, required: true},
    MINIMUM_ALLOWED_BUY_QUANTITY: {type: String, required: true},
    MAXIMUM_ALLOWED_BUY_QUANTITY: {type: String, required: true},
