...
//get product and filter details by sub sub category id
exports.get_product_by_subsubcategoryId = (req, res, next) => {
    ...
    Filter_category.find({SUB_SUB_CATEGORY_ID: id})
        ...
        .then(fil_cat => {
            if(fil_cat)
            {
                ...
                //look up filter options on the basis of sub sub category id
                Filter_options.find({SUB_SUB_CATEGORY_ID: id})
                    ...
                    .then(doc => {
                        ...
                        Product.find({PRODUCT_SUB_SUB_CATEGORY_ID: id})
                            ...
                            .then(doc_2 => {
                                ...
                                Ecommerce_prod_details.find({SUB_SUB_CATEGORY_ID: id})
