...
exports.product_details_get_by_id = (req, res, next) => {
    ...
    var rev_arr1 = [];
    var prod_final_rev_arr1 = [];

    var fil_arr1 = [];

    var perPage1 = 9;
    var page1 = req.params.page || 1;
                                ...
                                .then(ecom_doc => {
                                    ...
                                    Review.find({ACTIVE_FLAG:'Y'})
                                        ...
                                        .then(rev_doc => {
                                            ...
                                            FilterValues.find({PRODUCT_ID: prod_final_rev_arr[0].prod_details.prod_details.prod_id})
                                                ...
                                                .exec()
                                                .then(fil_docs => {
                                                    for(var item2 of fil_docs)

                                                    {
                                                        fil_arr.push({
                                                            filter_opt_prod_conn_id: item2._id,
                                                            prod_id: item2.PRODUCT_ID._id,
                                                            product_id: item2.PRODUCT_ID.PRODUCT_ID,
                                                            product_name: item2.PRODUCT_ID.PRODUCT_NAME,
                                                            filter_id: item2.FILTER_ID._id,
                                                            filter_type: item2.FILTER_ID.FILTER_CATEGORY_NAME,
                                                            filter_val_id: item2.FILTER_OPTION_ID._id,
                                                            filter_val_name: item2.FILTER_OPTION_ID.DISPLAY_TEXT,
                                                            updated_by_user: item2.UPDATED_BY,
                                                            updated_on: item2.UPDATED_DATE,
                                                            isActive: item2.ACTIVE_FLAG
                                                        })
                                                    }
                                                                ...
                                                                .then(count => {
                                                                    if(docs.length > 0)
                                                                    {
                                                                        ...
                                                                        for( var prod_item of docs)
                                                                        {
                                                                            ...
                                                                            //create an array with the basic product details
                                                                            prod_cat_arr1.push({prod_id: prod_item._id,
                                                                                product_id: prod_item.PRODUCT_ID,
                                                                                prod_category_id: prod_item.PRODUCT_CATEGORY_ID._id,
                                                                                prod_category_name: prod_item.PRODUCT_CATEGORY_ID.PRODUCT_CATEGORY_NAME,
                                                                                prod_sub_category_id: prod_item.PRODUCT_SUB_CATEGORY_ID._id,
                                                                        ...
                                                                        EcommProduct.find({ACTIVE_FLAG:'Y'})
                                                                            ...
                                                                            .then(ecom_doc => {
                                                                                //traverse through array with product details
                                                                                for (var prod_cat_item of prod_cat_arr1) {
                                                                                    ...
                                                                                    //push the ecommerce details array and the corresponding product details stored along with image details in final array
                                                                                    prod_final_arr1.push({prod_details: prod_cat_item, ecom_details: prod_arr1})
                                                                                ...
                                                                                Review.find({ACTIVE_FLAG:'Y'})
                                                                                    ...
                                                                                    .then(rev_doc => {
                                                                                        //traverse through array with product details
                                                                                        for (var prod_cat_item of prod_final_arr1) {
                                                                                            ...
                                                                                            //push the review details array and the corresponding updated product details above in the final array
                                                                                            prod_final_rev_arr1.push({ prod_details: prod_cat_item, review_details: rev_arr1})
